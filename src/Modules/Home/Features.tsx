  ...
  const cards = [
    {
      ...
      dec: "Comperhensive quality control and affordable prices",
    ...
    },
    {
      ...
      dec: "Worldwide storage and delivery made simple",
    ...
    {
      title: "Fast shipping",
      dec: "Fast and convenient door to door delivery",
    ...
    },
    {
      ...
      dec: "More than lO different secure payment methods",
    ...
    },
    {
      ...
      dec: "24/7 Customer service - we're here and happy to help",
          ...
          {cards.map((card, index) => (
            <Grid item xs={12} sm={6} md={3} key={index}>
              ...
              >
                ...
                <Typography variant="body2">{card.dec}</Typography>
              </Card>
            </Grid>
          ))}
        </Grid>
